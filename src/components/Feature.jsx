    ...
    return (
        <div className="feature  w-[100vw] h-[auto] flex flex-col justify-center items-center overflow-hidden ">
            ...
            <div className="flex p-6 w-[90vw] justify-center items-center">
                <div className="flex flex-col justify-around  items-center z-[1] bg-white/10 backdrop-blur-lg rounded-xl shadow-xl shadow-blue-300 group-[.dark-mode]:shadow-none group-[.dark-mode]:shadow-2xl max-w-[80%] h-[auto] p-4">
