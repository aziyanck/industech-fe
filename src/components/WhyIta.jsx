            ...
            <div className="flex flex-col justify-center items-center w-[90vw] h-[auto]">
                ...
                <div className="services w-[80vw] h-[auto] md:h-[80%] flex flex-col md:flex-row gap-10 justify-center items-center p-8 rounded-2xl">
                    ...
                    <div className="card-v ">
                        <div className=" w-[100px] m-4 h-[100px] rounded-full flex justify-center items-center l-bg"><i className="fa-solid dark-text-s i-text light-text-s fa-shield"></i></div>
                    ...
                    <div className="card-v ">
                        <div className=" w-[100px] m-4 h-[100px] rounded-full flex justify-center items-center l-bg"><i className="fa-solid dark-text-s i-text light-text-s fa-user-plus"></i></div>
                    ...
                    <div className="card-v ">
                        <div className=" w-[100px] m-4 h-[100px] rounded-full flex justify-center items-center l-bg"> <i className="fa-solid dark-text-s i-text light-text-s fa-check-to-slot"></i></div>
